...
// ExpectedDurationDays:response.order.ExpectedDurationDays||"",
//       ExpectedDurationDays: calculateDurationDays(
...
//     // Debug: Log the updated form details to ensure it has been set
//     console.log("Updated Form Order Details:", formOrderDetails);
...
console.log("OrderStatus from response:", response.order.OrderStatus);
  ...
  //  const selectedStatus = genderOptions.find(
  //   (gender) => gender.id === order?.OrderStatus
  // );
